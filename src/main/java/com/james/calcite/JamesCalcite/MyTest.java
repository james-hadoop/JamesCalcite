...
public class MyTest {
    public static void main(String[] args) {
        try {
            ...
            String sql1 = "select id, case when id > 0 then date_test else date_test end from table_result";
            ...
            System.out.println(String.format("columnNum = %d", columnNum));
            System.out.println(sqlParserPos);
