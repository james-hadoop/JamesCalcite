...
public class DogProjectConverter extends ConverterRule {
    ...
    public static final DogProjectConverter INSTANCE = new DogProjectConverter(LogicalProject.class, Convention.NONE,
            DogRel.CONVENTION, "DogProjectConverter");
    ...
    public RelNode convert(RelNode rel) {
        ...
        return new DogProject(logicalProject.getCluster(),
