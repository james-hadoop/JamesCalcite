...
public class DogTableScanConverter extends ConverterRule {
    ...
    public static final DogTableScanConverter INSTANCE = new DogTableScanConverter(EnumerableTableScan.class,
            EnumerableConvention.INSTANCE, DogRel.CONVENTION, "DogTableScan");
